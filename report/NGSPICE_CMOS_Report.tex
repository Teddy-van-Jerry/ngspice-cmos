...
\lstset{
  ...
  string = [b]{'},
  keywords=[1]{.title, .param, .temp, .inc, .ic, .tran, .control, .endc, .end, .ends, .measure, .subckt},
  keywords=[2]{run, set, hardcopy, if, else, end, shell, print},
}

\newcommand{\includeres}[1]{\sffamily\scriptsize\includesvg[width=\linewidth]{../fig/plot_#1_t.svg}}
